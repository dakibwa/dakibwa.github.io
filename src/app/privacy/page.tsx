      ...
      <main className="policy-page" id="main-content">
        ...
        <div className="policy-page__body">
          ...
          <section>
            <h2>Payments</h2>
            <p>
              Stripe processes online payments. Card and MB WAY details are entered directly into Stripe&apos;s secure
              checkout and are not stored by Português com a Inês. The booking system keeps only Stripe&apos;s opaque
